...
<div id="container">
	...
	<div id="content-container">
		...
		<div id="content">
			<head>
				<center><title>Average Joe's | Reports</title>
				<link rel="stylesheet" href="/style.css" type="text/css" />
			</head>
...
<?php
    ...
    // sending query
    $result = mysql_query("SELECT memberNumber AS 'Member ID',memberName AS 'Name',memberAccountBalance AS 'Current Balance' FROM {$tbl_name} WHERE memberAccountBalance > 0");
    if (!$result) {
    ...
    echo "Current Members with Outstanding Accounts:";
